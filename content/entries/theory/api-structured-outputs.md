...
- **Не путай отсутствие синтаксических ошибок с отсутствием логических** — пайплайн, полагающийся на
  structured outputs, всё ещё должен проверять бизнес-инварианты (сумма положительна, дата в разумном
  диапазоне) отдельно от факта, что JSON парсится — гарантия схемы снимает один класс проблем, но не
  все возможные.
