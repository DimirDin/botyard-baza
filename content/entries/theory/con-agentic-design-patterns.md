...
Практическое правило выбора — начинать с более простого и жёсткого паттерна, переходя к более гибкому
только когда конкретная проблема это оправдывает. Router с конечным известным набором категорий почти
всегда стоит предпочесть Orchestrator'у, если категории действительно конечны и не пересекаются —
сложность и непредсказуемость динамического планирования того не стоят, если задачу можно надёжно
решить простой классификацией. Тот же принцип, что и в общем совете «сначала workflow, потом agent»
из статьи Building Effective Agents.
