...
Суть проблемы, которую решает метод, легко проиллюстрировать на примере: чанк «увеличилась на 3% по
сравнению с прошлым кварталом» сам по себе бессмысленен для поиска — непонятно, о какой компании,
метрике и квартале речь, весь этот контекст был в остальной части документа, но потерян при нарезке
на чанки. Contextual Retrieval явно восстанавливает эту связь перед индексацией, добавляя короткое
пояснение вроде «выручка компании ACME в Q2 2025», так что чанк остаётся находимым по смыслу даже в
отрыве от исходного документа.
